...
<form method="POST" action="{{route('admin.primary.update', $police->id)}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <img src="{{asset($police->sec1_img)}}" alt="" style="width: 100px;height: 100px;display: block;margin-bottom: 20px;border-radius: 5px">
        <input type="file" class="form-control" id="img" name="sec1_img"  placeholder="Write Body.." value="{{$police->sec1_img}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="file" class="form-control" id="img" name="sec2_img"  placeholder="Write Body.." value="{{$police->sec1_img}}"> 
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="file" class="form-control" id="img" name="sec3_img"  placeholder="Write Body.." value="{{$police->sec1_img}}">
    </div>
    <div class="form-group">
